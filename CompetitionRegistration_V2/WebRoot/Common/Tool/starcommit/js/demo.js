...
$(function() {
	...
	$("#demo6 .ratyli").ratyli({
		onRated:function(value,init){
			...
			if(!init) {
//				alert(value); 
			document.getElementById("want_score").style.display="";
			document.getElementById("want_font_style").style.display="";
			document.getElementById("want_score").value =value;
//			$(".want_score").append(value);
			}// prevent run at init
		},
	});
