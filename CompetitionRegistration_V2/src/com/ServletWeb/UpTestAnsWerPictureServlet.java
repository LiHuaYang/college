...
public class UpTestAnsWerPictureServlet extends HttpServlet {
...
//		boolean flag = competition.Createtestpicture(TestId, HeadUrl, 20,
//				HeadUrl);
		...
		System.out.println("试卷答案图片文件名：" + HeadUrl);
