...
public class GetCompetitionObjectServlet extends HttpServlet {
	...
	throws ServletException, IOException {
     ...
     List<GradeBasicData> gradebasicdata = cd.GetCompetitionObject();
     JSONObject json = new JSONObject();
      ...
      jsonArray = new JSONArray().fromObject(gradebasicdata);
		...
		try {
			json.put("gradebasicdata", jsonArray);
		} catch (Exception e) {
			e.printStackTrace();
		}
