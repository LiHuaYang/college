...
public class GetContestPicUrlbyCompetitionId extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<String> ContestPicUrl= interfaceOfBllFrame
		.QueryCompetitionpic(CompetitionId);
		
		JSONObject jsonObject = new JSONObject();

		try {
			json = new JSONArray().fromObject(ContestPicUrl);
		} catch (Exception e) {
			e.printStackTrace();
