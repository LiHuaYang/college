...
public class ModifyHeadpicServlet extends HttpServlet {
	...
	throws ServletException, IOException {
			...
			HeadUrl = "C:\\Project\\apache-tomcat-9.0.0.M3\\webapps\\CompetitionRegistration\\Web\\image\\" + time + "." + ext;
			...
			System.out.println("图片路径：" +HeadUrl+ filename);
