...
public class QueryTextNumberServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String StudentGrade=request.getParameter("StudentGrade");
			...
			int TestPapers=interfaceOfBllFrame.QueryTextNumber(ContestSubject, CompetitionName, StudentGrade);

			jsonObject = new JSONObject();

			try {
				json=new JSONArray().fromObject(TestPapers);
			} catch (Exception e) {
				e.printStackTrace();
