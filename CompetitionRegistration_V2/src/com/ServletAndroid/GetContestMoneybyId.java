...
public class GetContestMoneybyId extends HttpServlet {
...
//			System.out.println("qqqqqqqq"+contestId);
	        
			IBllFrame interfaceOfBllFrame=CBllFrame.getInstance();
			JSONArray json = null;
			
			
			CompetitionBasicInfo newsInfo=interfaceOfBllFrame.SearchContestMoneybyId(contestId);
			...
			System.out.println("报名费结果"+jsonObject);
