...
//			List<String> picUrl = getImgUrlList(html);
			...
			for (Iterator<Element> it=elses.iterator(); it.hasNext(); ) {
				System.out.println(it.next().select("img").attr("src"));
			}
...
//		downLoadQQBq("C:\\test\\qqBq111.html");
	...
	public static String writeFile(List<String> picUrls) throws Exception {
		...
		for (Iterator<String> it = picUrls.iterator(); it.hasNext(); ) {
