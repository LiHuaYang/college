...
public class WChangeCleanerServlet extends HttpServlet {
	...
	throws ServletException, IOException {
		...
		Cleaner cleaner = new Cleaner(CleanerId, CleanerName, CleanerSex, CleanerPhoneNumber, CleanerState, CleanerIDNumber, CleanerPassWord);
