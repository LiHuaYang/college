...
<!-- -------------------------------------------------------------------------------------------- -->
								<table class="data-table">
									...
									<tr>
										...
										<td><input value="2"></td>
										<td>入住时间:</td>
										<td><input value="2015-1-10"></td>
									</tr>
									<tr class="odd">
										<td>退房时间:</td>
										<td><input value="2015-1-11"></td>
										<td>付款金额:</td>
										<td><input value="200"></td>
									</tr>
									<tr>
										<td>房间号</td>
										<td><input value="201"></td>
										<td>客户号:</td>
										<td><input value="101"></td>
									</tr>
									<tr>
										<td>下单客户ID号:</td>
										<td><input value="201214"></td>
										<td>下单电话号码：</td>
										<td><input value="178261621728"></td>
									</tr>
            						<tr>
										<td>下单客户姓名:</td>
										<td><input value="老王"></td>
										<td>订单状态：</td>
										<td><select><option>完成</option><option>未完成</option></select></td>
									</tr>
								</table>
<!-- -------------------------------------------------------------------------------------------- -->                               
                                </div>
