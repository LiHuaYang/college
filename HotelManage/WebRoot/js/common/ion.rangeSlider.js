		...
		init: function(fa) {
			return this.each(function() {
				...
				if (!e.data("isActive")) {
					...
					var M = function() {
						n.html('<span class="irs"><span class="irs-line"><span class="irs-line-left"></span><span class="irs-line-mid"></span><span class="irs-line-right"></span></span><span class="irs-min">0</span><span class="irs-max">1</span><span class="irs-from" id="irs-fromid">0</span><span class="irs-to" id="irs-toid">0</span><span class="irs-single">0</span></span><span class="irs-grid"></span>');
						p = n.find(".irs");
						D = p.find(".irs-min");
						E = p.find(".irs-max");
						A = p.find("#irs-fromid");
